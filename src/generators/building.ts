...
function buildMine(scene: GeneratedScene, profile: BuildingProfile, width: number, depth: number, floorHeightFeet: number[], rng: GeneratorContext["rng"]): void {
  ...
  scene.primitives.push(
    ...
    box("mine-upper-platform", 1, hubX, upperY, hubZ, 7, FLOOR_SLAB_METERS, 6, "wood", ["floor", "standable", "shaft-platform", "platform"]),
    box("mine-lower-hub", 0, hubX, lowerY, depth * 0.72, 9, FLOOR_SLAB_METERS, 7, "rock", ["floor", "standable", "mine-hub", "platform"]),
