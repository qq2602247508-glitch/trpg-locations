...
export function generateScene(request: GenerationRequest, requestedKind: SceneKind = "adaptive", suppliedClassification?: InputClassification, suppliedProgram?: SceneProgram): GeneratedScene {
  ...
  const strongSettlementNouns = ["城镇", "村庄", "村落", "渔猎村", "市场村", "聚居地", "街区", "港区", "港口区", "港镇", "贵族区", "贫民区", "商业区", "住宅区", "殖民地区", "深水城", "水城", "运河城", "塔楼城市", "巨塔城市", "城市分布在", "聚落", "小镇", "town", "village", "market village", "district", "harbor", "port town", "water city", "canal city", "tower city", "megastructure city", "settlement"];
  const wildernessBuildingOwnsSite = ["木屋", "小屋", "猎人屋", "cabin", "lodge", "hut", "cottage", "outpost"].some((term) => programText.includes(term))
    && ["森林", "树林", "林间", "巨树", "树根", "山地", "河谷", "沼泽", "海岸", "forest", "woodland", "tree", "mountain", "valley", "swamp", "coast"].some((term) => programText.includes(term));
