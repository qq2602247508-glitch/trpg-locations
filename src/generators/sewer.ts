...
export function generateSewer(context: GeneratorContext): GeneratedScene {
  ...
  scene.primitives.push(
    ...
    corridor("sewer-lower-inspection-way", 0, 1.5, walkZ, width - 1.5, walkZ, lowerY + FLOOR_SLAB_METERS, 2.2, "stone", ["maintenance-way"]),
    corridor("sewer-upper-gallery-floor", 1, 2.5, upperWalkZ, width - 2.5, upperWalkZ, upperY + FLOOR_SLAB_METERS, 2.4, "stone", ["maintenance-way", "upper"]),
